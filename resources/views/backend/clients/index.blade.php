...
@section('page_title' , trans('backend.clients'))
@section('style')
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable" id="table1">
                    <thead>
                    <tr>
                        <th>{{trans('backend.name_client')}}</th>
...
@section('script')
    ...
    @include('backend.clients.create')
    @include('backend.clients.edit')
    @include('backend.clients.avatar')
    @include('backend.clients.show')
