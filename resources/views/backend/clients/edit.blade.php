                ...
                <form id="mmm"
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-lg-3 col-sm-12">{{trans('backend.name_client')}}</label>
...
<script type="application/javascript">
    ...
    function getItemDetails(id) {
        ...
        Service.ajaxReqWithLang("{{url('admin/clients' )}}/" + id,
                        {},
