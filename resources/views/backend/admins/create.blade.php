    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!--begin::Form-->
                <form action="{{ route('admins.store') }}" method="POST" id="frm-insert"
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-3 col-sm-12">{{trans('backend.role')}}</label>
                        <div class="col-lg-9 col-md-9 col-sm-12">

                            <select class="form-control select3" multiple="multiple"data-placeholder="Select a State"
                                    name="roles[]" required >
